...
class Project extends Component {
    render () {
        return (
            <>
                <div className = "px-30 pt-10 grid grid-cols-2">
                    <div className = "">
                        <img className = "w-150 h-80 rounded-2xl" src = "../src/dummydata/images/CardImage.png" />
                    </div>
                    <div className = "ml-10">
                        <h2 className = "text-3xl font-thin">가을의 섬</h2>
                        <div className = "flex">
